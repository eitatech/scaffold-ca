...
/** A simple functional test for the 'tech.eita.greeting' plugin. */
public class PluginCleanFunctionalTest {
  ...
  public static final String
      BUILD_FUNCTIONAL_TEST_INFRASTRUCTURE_ENTRY_POINTS_API_REST_SRC_MAIN_JAVA_TECH_EITA_API_API_REST_JAVA =
          "build/functionalTest/infrastructure/entry-points/api-rest/src/main/java/tech/eita/api/ApiRest.java";
  public static final String
  ...
  public void canRunTaskGenerateStructureWithOutLombok() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/applications/app-service/src/main/java/tech/eita/MainApplication.java")
            .exists());
    assertTrue(
        new File(
  ...
  public void canRunTaskGenerateModelWithParameters() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/domain/model/src/main/java/tech/eita/model/testmodel/gateways/TestModelRepository.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/domain/model/src/main/java/tech/eita/model/testmodel/TestModel.java")
            .exists());
  ...
  public void canRunTaskGenerateUseCaseWithParameters() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/domain/usecase/src/main/java/tech/eita/usecase/business/BusinessUseCase.java")
            .exists());
  ...
  public void canRunTaskGenerateDrivenAdapterRestConsumerCaseWithParameters() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/rest-consumer/src/main/java/tech/eita/consumer/RestConsumer.java")
            .exists());
    assertTrue(
  ...
  public void canRunTaskGenerateEntryPointGraphqlApiCase() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/graphql-api/src/main/java/tech/eita/graphqlapi/ApiQueries.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/graphql-api/src/main/java/tech/eita/graphqlapi/ApiMutations.java")
            .exists());
  ...
  public void canRunTaskGenerateDrivenAdapterRSocketRequesterCase() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/rsocket-requester/src/main/java/tech/eita/rsocket/config/RequesterConfig.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/rsocket-requester/src/main/java/tech/eita/rsocket/service/RsocketAdapter.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/rsocket-requester/src/test/java/tech/eita/rsocket/service")
            .exists());
    assertEquals(result.task(":" + task).getOutcome(), TaskOutcome.SUCCESS);
  }
  ...
  public void canRunTaskGenerateEntryPointRSocketResponderCase() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/rsocket-responder/src/main/java/tech/eita/controller/RsocketController.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/rsocket-responder/src/test/java/tech/eita/controller")
            .exists());
    assertEquals(result.task(":" + task).getOutcome(), TaskOutcome.SUCCESS);
  }
  ...
  public void canRunTaskGenerateDrivenAdapterWithParameters() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/jpa-repository/src/main/java/tech/eita/jpa/JPARepository.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/jpa-repository/src/main/java/tech/eita/jpa/JPARepositoryAdapter.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/jpa-repository/src/main/java/tech/eita/jpa/helper/AdapterOperations.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/jpa-repository/src/main/java/tech/eita/jpa/config/JpaConfig.java")
            .exists());
  ...
  public void canRunTaskGenerateDrivenAdapterEventBusTest() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/async-event-bus/src/main/java/tech/eita/events/ReactiveEventsGateway.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/async-event-bus/src/main/java/tech/eita/events/ReactiveDirectAsyncGateway.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/domain/model/src/main/java/tech/eita/model/events/gateways/EventsGateway.java")
            .exists());
  ...
  public void canRunTaskGenerateEntryPointEventHandlerTest() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/async-event-handler/src/main/java/tech/eita/events/HandlerRegistryConfiguration.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/async-event-handler/src/main/java/tech/eita/events/handlers/EventsHandler.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/async-event-handler/src/main/java/tech/eita/events/handlers/CommandsHandler.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/async-event-handler/src/main/java/tech/eita/events/handlers/QueriesHandler.java")
            .exists());
  ...
  public void canRunTaskGenerateDrivenAdapterR2dbcPostgreSQLTest() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/r2dbc-postgresql/src/main/java/tech/eita/config/PostgreSQLConnectionPool.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/r2dbc-postgresql/src/main/java/tech/eita/config/PostgresqlConnectionProperties.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/r2dbc-postgresql/src/main/java/tech/eita/MyReactiveRepository.java")
            .exists());
    assertEquals(result.task(":" + task).getOutcome(), TaskOutcome.SUCCESS);
  }
  ...
  public void canRunTaskGenerateDrivenAdapterKmsTest() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/kms-repository/src/main/java/tech/eita/kms/KmsAdapter.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/kms-repository/src/main/java/tech/eita/kms/config/KmsConfig.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/kms-repository/src/main/java/tech/eita/kms/config/model/KmsConnectionProperties.java")
            .exists());
  ...
  public void canRunTaskGenerateDrivenAdapterS3Test() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/s3-repository/src/main/java/tech/eita/s3/adapter/S3Adapter.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/s3-repository/src/main/java/tech/eita/s3/operations/S3Operations.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/s3-repository/src/main/java/tech/eita/s3/config/S3Config.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/s3-repository/src/main/java/tech/eita/s3/config/model/S3ConnectionProperties.java")
            .exists());
  ...
  public void canRunTaskGenerateHelperTest() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/helpers/s3-helper/src/main/java/tech/eita/s3helper")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/helpers/s3-helper/src/test/java/tech/eita/s3helper")
            .exists());
  ...
  public void shouldGenerateMQEntryPoint() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/entry-points/mq-listener/src/main/java/tech/eita/mq/listener/SampleMQMessageListener.java")
            .exists());
    assertEquals(result.task(":" + task).getOutcome(), TaskOutcome.SUCCESS);
  }
  ...
  public void shouldGenerateMQDrivenAdapter() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/mq-sender/src/main/java/tech/eita/mq/sender/SampleMQMessageSender.java")
            .exists());
    assertEquals(result.task(":" + task).getOutcome(), TaskOutcome.SUCCESS);
  }
  ...
  public void canRunTaskGenerateDrivenAdapterKtorClient() throws IOException {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/ktor-client/src/main/kotlin/tech/eita/client/KtorClient.kt")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/ktor-client/src/main/kotlin/tech/eita/client/config/KtorConfig.kt")
            .exists());
    assertTrue(
  ...
  public void canRunTaskGenerateStructureKotlinWithOutParameters() throws IOException {
    ...
    assertTrue(
        new File(
                "build/functionalTest/applications/app-service/src/main/kotlin/tech/eita/MainApplication.kt")
            .exists());
    assertTrue(
        new File(
    ...
    assertTrue(
        new File(
            ...
            .exists());
    assertTrue(
        new File("build/functionalTest/applications/app-service/src/test/kotlin/tech/eita")
            .exists());
  ...
  public void canRunTaskGenerateDynamoDBDrivenAdapterInKotlin() throws IOException {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/dynamo-db/src/main/kotlin/tech/eita/dynamodb/DynamoDBTemplateAdapter.kt")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/dynamo-db/src/main/kotlin/tech/eita/dynamodb/config/DynamoDBConfig.kt")
            .exists());
    assertTrue(
  ...
  public void shouldGenerateDynamoDBDrivenAdapterInJava() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/dynamo-db/src/main/java/tech/eita/dynamodb/DynamoDBTemplateAdapter.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/dynamo-db/src/main/java/tech/eita/dynamodb/ModelEntity.java")
            .exists());
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/dynamo-db/src/main/java/tech/eita/dynamodb/config/DynamoDBConfig.java")
            .exists());
    assertTrue(
  ...
  public void shouldGenerateBinStashDrivenAdapterInJavaReactive() {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/bin-stash/src/main/java/tech/eita/binstash/config/BinStashCacheConfig.java")
            .exists());
    assertTrue(
  ...
  public void shouldGenerateBinStashDrivenAdapterInKotlin() throws IOException {
    ...
    assertTrue(
        new File(
                "build/functionalTest/infrastructure/driven-adapters/bin-stash/src/main/kotlin/tech/eita/binstash/config/BinStashCacheConfig.kt")
            .exists());
    assertTrue(
