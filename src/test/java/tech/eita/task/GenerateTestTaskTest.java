...
public class GenerateTestTaskTest {
  ...
  public void generateAcceptanceTest() throws IOException, CleanException {
    ...
    assertTrue(
        new File(
                "build/unitTest/deployment/acceptance-test/src/test/java/tech/eita/TestParallel.java")
            .exists());
    assertTrue(
        new File(
                "build/unitTest/deployment/acceptance-test/src/test/java/tech/eita/demo/DemoRunner.java")
            .exists());
    assertTrue(
    ...
    assertTrue(
        new File(
                "build/unitTest/deployment/acceptance-test/src/test/resources/tech/eita/demo/demo.feature")
            .exists());
